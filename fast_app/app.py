...
description = """
fast_app API helps you do awesome stuff. 🚀
"""
...
app = FastAPI(
    ...
    terms_of_service="http://fast_app.com/terms/",
    contact={
        "name": "Harnath-Eunimart",
        "url": "http://fast_app.com/contact/",
        "email": "Harnath-Eunimart@fast_app.com",
    },
    license_info={
        "name": "The Unlicense",
